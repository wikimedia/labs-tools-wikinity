...
<body>
  ...
  <nav class="navbar navbar-inverse bg-faded" style="background-color:#337ab7;border-color: 2e6da4">
      ...
      <form style="color: 000" class="navbar-brand" style="float: right">
      ...
      <a style="float: right;color: #fff" class="navbar-brand" href="https://github.com/urbanecm/wikinity/issues/new">Nahlásit problém</a>
